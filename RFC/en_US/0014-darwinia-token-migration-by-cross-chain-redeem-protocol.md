...
This article will discuss the Darwinia mainnet on the basis of [RFC-0012: Darwinia Bridge Core: Interoperation in ChainRelay Enabled Blockchains](./0012-darwinia-bridge-core-interoperation-in-chainrelay-enabled-blockchains.md) Later, how can ERC-20 RING be redeemed to the Darwinia network, and how to use the design of the Darwinia bridge, how the Token will be transferred in the Darwinia main network and other public chains.
